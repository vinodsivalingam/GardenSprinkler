...
public class AlarmEntry implements Comparable, java.io.Serializable {
    ...
    public AlarmEntry(String _name, int[] _minutes, int[] _hours, int[] _daysOfMonth, int[] _months, int[] _daysOfWeek,
			int _year, AlarmListener _listener, Schedule s) throws PastDateException {
